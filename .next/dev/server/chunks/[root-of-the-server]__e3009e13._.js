...
"[project]/app/api/actions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ACTIONS_FILE = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(process.cwd(), 'actions.json');
async function GET() {
    try {
        // Check if actions file exists
        if (!(0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["existsSync"])(ACTIONS_FILE)) {
        ...
        const content = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["readFile"])(ACTIONS_FILE, 'utf-8');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3009e13._.js.map